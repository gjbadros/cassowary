...
public class RectangleCC extends ConstrComponent {
    ...
    public void draw(Graphics g) {
        ...
        if (!isSelected && !isHighlighted) {
            // Don't redraw the box sides, as the bbox of the rectangle was
            // drawn
            // by the base class
            g.setColor(c);
    ...
    protected void notifySelPointReplacement(int idx, SelPoint newsp) {
        ...
        /*
         * System.out.println("Rectangle: Replacing idx " + idx + " with " +
         * newsp);
         */
 ...
 * 
 * Revision 1.3 1998/06/23 02:08:40 gjb Added import of cassowary package so
 ...
 * 
 * Revision 1.5 1998/04/15 00:08:57 Michael Changed drawing of rectangle so
 ...
 * 
 * Revision 1.2 1998/04/01 10:11:42 Michael Added cleanUp function, code to set
 * interested CC's
 * 
