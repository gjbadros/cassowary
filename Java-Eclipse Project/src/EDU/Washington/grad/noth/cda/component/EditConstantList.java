...
public class EditConstantList {
    ...
    public void registerDelta(SelPoint sp, Point delta) {
        ...
        // System.out.println("ECP.regDelta: selPAL = "
        // +selPointAssocList.size());
    ...
    public final synchronized String toString() {
        ...
        for (int a = 0; a < ec.size() - 1; a++) {
            retstr = retstr.concat(String
                    .valueOf(ec.elementAt(a).doubleValue()));
            retstr = retstr.concat(", ");
        }
        if (ec.size() > 0)
            retstr = retstr.concat(String.valueOf(ec.elementAt(ec.size() - 1)
                    .doubleValue()));
 ...
 * 
 * Revision 1.3 1998/06/23 02:08:38 gjb Added import of cassowary package so
 ...
 * 
 * Revision 1.3 1998/02/25 10:39:02 Michael Added SelPoint association list to
 * facilitate point sharing
 * 
 * Revision 1.2 1998/02/16 10:34:38 Michael Fixed off-by-one bug and added some
 * sanity checks
 * 
