...
public final class DPMouseMotionListener extends MouseAdapter implements
        MouseMotionListener {
 ...
 * 
 * Revision 1.2 1998/05/09 00:30:31 gjb Remove cr-s
 * 
 * Revision 1.1 1998/05/09 00:11:13 gjb Added
 * 
 * Revision 1.2 1998/04/08 05:38:27 Michael Removed printing msgs and changed
 * interface to mouse motion callback
 * 
 * Revision 1.1 1998/04/01 10:16:41 Michael Shortened names
 * 
 * Revision 1.6 1998/03/27 06:24:52 Michael Added code to allow picking a target
 * CC for relational constraints
 * 
 * Revision 1.5 1998/03/25 02:47:19 Michael Added CC selection functions
 * 
 * Revision 1.4 1998/03/19 09:18:49 Michael Added hooks for rectangle CC
 * 
 * Revision 1.3 1998/03/02 06:45:07 Michael Extensive changes to move to
 * CCG-based list of parts
 * 
 * Revision 1.2 1998/02/25 10:40:43 Michael Added first cut of internal grouping
 * for point sharing
 * 
 * Revision 1.1 1998/02/17 10:42:00 Michael Split files with multiple classes
 */
