...
public class MainPanelComponentListener extends ComponentAdapter implements
        ComponentListener {
    ...
    public void componentResized(ComponentEvent e) {
        ...
        /*
         * System.out.println("MPCl.cR requesting drawPanel dims (" + d.width +
         * ", " + d.height + ")");
         */
        if (d.width < 100)
            d.width = 100;
 ...
 * Revision 1.3 1999/12/16 02:10:02
 ...
 * 
 * Revision 1.4 1998/04/28 20:09:11 Michael Removed debugging code
 * 
 * Revision 1.3 1998/04/26 06:16:12 Michael Changed layout
 * 
 * Revision 1.2 1998/04/08 05:39:29 Michael Changed default width of DrawPanel
 * 
 * Revision 1.1 1998/02/17 10:42:01 Michael Split files with multiple classes
 */
