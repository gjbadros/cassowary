 ...
 * Revision 1.4 1999/12/16 02:10:01
 * gjb java/cda/Makefile.am: Put Constraint/, Main/ files into the distribution
 * and build with them. java/demos/.java: Move everything into the
 ...
 * 
 * Revision 1.3 1998/05/14 23:40:06 gjb Patch from noth to redraw the buttons
 * after they are clicked to fix the disappearing icon bug that appears (only)
 * on linux
 * 
 * Revision 1.2 1998/05/09 00:30:30 gjb Remove cr-s
 * 
 * Revision 1.1 1998/05/09 00:11:12 gjb Added
 * 
 * Revision 1.5 1998/04/23 09:00:55 Michael Added alignment constraint buttons
 * 
 * Revision 1.4 1998/04/08 05:40:14 Michael Removed printing msg
 * 
 * Revision 1.3 1998/04/02 06:59:56 Michael Added relational constraints
 * 
 * Revision 1.2 1998/03/27 06:23:34 Michael Added new buttons for relational
 * constraints
 * 
