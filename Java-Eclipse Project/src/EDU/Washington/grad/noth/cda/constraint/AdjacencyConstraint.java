...
public abstract class AdjacencyConstraint extends Constraint {
    ...
    // Vector of Vector<SelPoint> constraints upon the target's SelPoints
    protected Vector<ClConstraint> relConstrs;
    ...
    public AdjacencyConstraint(ClSimplexSolver solver, ConstrComponent srcCC,
        ...
        relConstrs = new Vector<ClConstraint>(targetCC.selPoints.size());
        addConstraints();
    }
    ...
    public void removeConstraints() {
        ...
        for (a = 0; a < relConstrs.size(); a++) {
            ...
            try {
                ...
                System.out
                        .println("AdjConstr.remConstr: ExCLConstraintNotFound "
                                + "removing #" + a + " = " + cli);
            }
        }
    ...
    public void replaceSelPoint(SelPoint oldsp, SelPoint newsp) {
        ...
        if (ccList.size() != 2) {
            System.out
                    .println("AdjConstr.repSP: Ill-formed AdjacencyConstraint!");
            return;
        } else {
    ...
    public void notifyCCRemoval(ConstrComponent c) {
        /*
         * System.out.println("AdjConstr.notifyCCRem: Removing " + c + " from "
         * + ccList);
         */
 ...
 * 
 * Revision 1.3 1998/06/23 02:08:44 gjb Added import of cassowary package so
 ...
 * 
 * Revision 1.3 1998/04/10 01:58:44 Michael Fixed bug preventing AdjConstrs from
 * being flagged removable when they were
 * 
