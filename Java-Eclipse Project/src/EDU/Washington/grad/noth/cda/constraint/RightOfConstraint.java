    ...
    public void addConstraints() {
        ...
        if (relConstrs.size() != targetCC.selPoints.size()) {
            ...
            for (a = 0; a < targetCC.selPoints.size(); a++) {
                ...
                try {
                    cli = new ClLinearInequality(sp.X(), CL.Op.GEQ,
                            srcCC.rightSP.X());
                } catch (ExCLInternalError e) {
                    System.out
                            .println("RightOfConstr.constructor: ExCLInternalError"
                                    + " on #" + a);
                    return;
                }
        ...
        for (a = 0; a < relConstrs.size(); a++) {
            ...
            try {
                ...
                System.out
                        .println("RightOfConstr.addConstr: ExCLRequiredFailure "
                                + "adding #" + a + " = " + cli);
            }
        }
 ...
 * 
 * Revision 1.3 1998/06/23 02:08:50 gjb Added import of cassowary package so
