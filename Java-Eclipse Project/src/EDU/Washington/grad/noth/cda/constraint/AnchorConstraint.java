...
public class AnchorConstraint extends Constraint {
    ...
    public void replaceSelPoint(SelPoint oldsp, SelPoint newsp) {
        if (selPointList.size() != 1) {
            /*
             * System.out.print("Error--" + selPointList.size() +
             * " points in list");
 ...
 * 
 * Revision 1.3 1998/06/23 02:08:46 gjb Added import of cassowary package so
 ...
 * 
 * Revision 1.5 1998/04/20 09:52:44 Michael Added code for
