...
public abstract class Constraint {
    ...
    public Vector<SelPoint> selPointList;

    // List of CC's being constrained
    public Vector<ConstrComponent> ccList;
    ...
    public Constraint(ClSimplexSolver solver) {
        this.solver = solver;
        selPointList = new Vector<SelPoint>(10);
        ccList = new Vector<ConstrComponent>(10);
    ...
    public void addSelPoint(Vector<SelPoint> v) {
        SelPoint sp;
        int a;
        ...
        for (a = 0; a < v.size(); a++) {
            ...
            if (!(sp instanceof SelPoint)) {
                System.out
                        .println("C.addSP: Element " + a + " not a SelPoint!");
                return;
            }
            addSelPoint(sp);
        }
 ...
 * 
 * Revision 1.5 1998/04/20 09:52:21 Michael Added code for
 ...
 * 
 * Revision 1.2 1998/04/01 10:20:04 Michael Added replaceSelPoint,
 * notifyCCRemoval, and canDiscard methods Added fields to allow a Constraint
 * obj to be over CC's as well as SelPoints
 * 
