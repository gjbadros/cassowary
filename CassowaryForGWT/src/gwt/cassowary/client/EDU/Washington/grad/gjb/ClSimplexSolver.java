...
public class ClSimplexSolver extends ClTableau {
   ...
   public final ClSimplexSolver addLowerBound(ClAbstractVariable v, double lower) throws ExCLRequiredFailure, ExCLInternalError {
      ClLinearInequality cn = new ClLinearInequality(v, CL.Op.GEQ, new ClLinearExpression(lower));
   ...
   public final ClSimplexSolver addUpperBound(ClAbstractVariable v, double upper) throws ExCLRequiredFailure, ExCLInternalError {
      ClLinearInequality cn = new ClLinearInequality(v, CL.Op.LEQ, new ClLinearExpression(upper));
      return addConstraint(cn);
   }
   ...
   public final ClSimplexSolver addConstraint(ClConstraint cn) throws ExCLRequiredFailure, ExCLInternalError {
      ...
      ClLinearExpression expr = newExpression(cn, /* output to: */eplus_eminus, prevEConstant);
   ...
   public final ClSimplexSolver removeConstraint(ClConstraint cn) throws ExCLConstraintNotFound, ExCLInternalError {
      ...
      if (rowExpression(marker) != null) {
         /*
          * LM -- removed because this doesn't force JIT to purge the reference ClLinearExpression expr = removeRow(marker); expr =
          * null;
          */
         removeRow(marker);
      }
