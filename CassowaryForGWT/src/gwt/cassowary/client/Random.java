...
/**
 * This class provides methods that generates pseudo-random numbers of different types, such as int, long, double and float using
 * either
 * 
 * @see Properties
...
public class Random implements Serializable {
    ...
    * 
    * @param seed
    *           the seed that will determine the initial state of this random number generator
    * 
    * @see #setSeed
    */
   ...
   /**
    * Returns a pseudo-random uniformly distributed <code>int</code> value of the number of bits specified by the argument
    * <code>bits</code>.
    * 
    * Implements D. H. Lehmer's random number algorithm found in <i>The Art of Computer Programming, Volume 2: Seminumerical
    * Algorithms</i>, by Donald E. Knuth (section 3.2.1).
    * 
   ...
   /**
    * Returns a pseudo-randomly generated, normally distributed <code>double</code> value with mean 0.0 and a standard deviation
    * value of <code>1.0</code>.
    * 
    * Implements G. E. P. Box, M. E. Muller, and G. Marsaglia's polar method found in <i>The Art of Computer Programming, Volume 2:
    * Seminumerical Algorithms</i>, by Donald E. Knuth (section 3.4.1).
    * 
   ...
   /**
    * Returns a new pseudo-random integer value which is uniformly distributed between 0 (inclusively) and <code>n</code>
    * (exclusively).
    * 
   ...
   /**
    * Modifies the seed using a linear congruential formula, as found in <i>The Art of Computer Programming, Volume 2</i>, by Donald
