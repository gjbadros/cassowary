...
/*  A Bison parser, made from creader.y
...
static const short yyrhs[] = {    16,
     0,    17,     0,     4,    12,    18,     0,     4,     5,    18,
     0,     4,     6,    18,     0,     3,     0,     4,     0,    18,
     8,    18,     0,    18,     7,    18,     0,    18,     9,    18,
     0,    18,    10,    18,     0,    13,    18,    14,     0
};
...
"GEQ","LEQ","'-'","'+'","'*'","'/'","NEG","'='","'('","')'","constraint","equation",
"inequality","expr", NULL
};
#endif

static const short yyr1[] = {     0,
    15,    15,    16,    17,    17,    18,    18,    18,    18,    18,
    18,    18
};
...
static const short yypact[] = {     3,
     8,-32768,-32768,     2,     2,     2,-32768,-32768,     2,    17,
    17,    17,     9,     2,     2,     2,     2,-32768,    -7,    -7,
...
static const short yytable[] = {    11,
    12,    16,    17,    13,     7,     8,     1,     0,    19,    20,
    21,    22,     4,     5,     9,    14,    15,    16,    17,     6,
    24,    25,    18,    14,    15,    16,    17
};

static const short yycheck[] = {     5,
     6,     9,    10,     9,     3,     4,     4,    -1,    14,    15,
    16,    17,     5,     6,    13,     7,     8,     9,    10,    12,
     0,     0,    14,     7,     8,     9,    10
};
#define YYPURE 1
...
case 1:
//#line 51 "creader.y"
{ yyval.clcons = yyvsp[0].clcons;
                                     ((yyarg*)YYPARSE_PARAM)->_clcons = yyvsp[0].clcons;  ;
    break;}
case 2:
//#line 53 "creader.y"
{ yyval.clcons = yyvsp[0].clcons;
...
case 3:
//#line 57 "creader.y"
{ yyval.clcons = new ClLinearEquation(*yyvsp[-2].clvar, *yyvsp[0].clexpr);
    break;}
case 4:
//#line 61 "creader.y"
{ yyval.clcons = new ClLinearInequality(*yyvsp[-2].clvar, cnGEQ, *yyvsp[0].clexpr);
    break;}
case 5:
//#line 63 "creader.y"
{ yyval.clcons = new ClLinearInequality(*yyvsp[-2].clvar, cnLEQ, *yyvsp[0].clexpr);
    break;}
case 6:
//#line 67 "creader.y"
{ yyval.clexpr = new ClLinearExpression(yyvsp[0].num);        ;
    break;}
case 7:
//#line 68 "creader.y"
{ yyval.clexpr = new ClLinearExpression(*yyvsp[0].clvar);       ;
    break;}
case 8:
//#line 69 "creader.y"
{ yyval.clexpr = new ClLinearExpression(*yyvsp[-2].clexpr + *yyvsp[0].clexpr); 
    break;}
case 9:
//#line 71 "creader.y"
{ yyval.clexpr = new ClLinearExpression(*yyvsp[-2].clexpr - *yyvsp[0].clexpr); 
